...
api_key = '5b3ce3597851110001cf6248c31d40ed157f41e9ade08674bc18519b'
...
def CreateBufferPolygon(point_in, resolution=2, radius=300):
    ...
    point_buffer_proj = Point(point_in_proj).buffer(radius, resolution=resolution)  # 300 m buffer
...
with fn.open(hotpoints_file, 'r') as hp_data:  # Open data in reading mode
    ...
    for data in hp_data:
        ...
        # Create buffer polygons around affected sites with 300 m radius and low resolution
...
coordinates = [[114.04589,22.51236], [114.06619,22.54685]]  # OD
